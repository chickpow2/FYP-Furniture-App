...
public class ARMenuFragment extends Fragment {

    private static final String TAG = ARMenuFragment.class.getSimpleName();
    ...
    public ARMenuFragment() {
        // Required empty public constructor
    }

    public static ARMenuFragment newInstance(String param1, String param2) {
        ARMenuFragment fragment = new ARMenuFragment();
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(mAdapter.context, recyclerView ,new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    @Override public void onItemClick(View view, int position) {
                        ...
                        selection = furniture.getModel();  //abcde
                        Intent intent=new Intent(getActivity().getApplicationContext(), GltfFragment.class);//change this
    ...
    private String GET(String url) {
        ...
        try {
            java.net.URL url_link = new URL(url);
