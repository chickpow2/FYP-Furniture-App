...
public class TouchEventSystem {
  ...
  public void onTouchEvent(HitTestResult hitTestResult, MotionEvent motionEvent) {
    ...
    if (handlingTouchListener != null) {
      ...
      TouchTarget newTouchTarget = null; //duplicate? //////////////////////////////////////////////////
      ...
      if ((actionMasked == MotionEvent.ACTION_DOWN
          || (actionMasked == MotionEvent.ACTION_POINTER_DOWN))) { /////////////////////////////////warning
    ...
    if (actionMasked == MotionEvent.ACTION_CANCEL || actionMasked == MotionEvent.ACTION_UP) {  /////////////////////////////////warning/////////////////////////
      clearTouchTargets();
  ...
  private boolean tryDispatchToSceneTouchListener(
    ...
    // This is a new gesture, give the touch listener a chance to capture the input.  /////////////////////////////////warning
