                    ...
                    <%
                        ...
                        for (int i = 0; i < furnitureList.size(); i++) {
                            out.println("<tr><br><div class='col-xl-4 col-lg-4 col-md-6 col-sm-12'>"
                                    ...
                                    + "<a class='add-bt' href=\"handleFurniture?action=putToCart&id=" + furnitureList.get(i).getFurnitureId() + "\">Add to cart<a href=\"handleFurniture?action=limitShowOneFurniture&id=" + furnitureList.get(i).getFurnitureId() + "\"</a>"
                                    + "</div></div></div>"
