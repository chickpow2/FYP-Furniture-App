                            ...
                            <div id="myCarousel" class="carousel slide banner_Client" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <%int a = Integer.parseInt(c.getID()) + 1;
                                            int b = Integer.parseInt(c.getID()) + 2;  //warning maybe use for loop instead 
                                        %>               
                                    ...
                                    <div class="carousel-item ">
                                        ...
                                        <figure><img src="interior_design/<%out.print(a);%>.jpg"/></figure>
                                    ...
                                    <div class="carousel-item ">
                                        ...
                                        <figure><img src="interior_design/<%out.print(b);%>.jpg"/></figure>
